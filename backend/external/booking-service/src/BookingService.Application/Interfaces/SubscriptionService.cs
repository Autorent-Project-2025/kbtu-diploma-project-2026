...
public class SubscriptionService : ISubscriptionService
{
    ...
    public async Task<SubscriptionResponseDto> CreateSubscription(Guid userId, CreateSubscriptionDto dto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<SubscriptionResponseDto?> GetActiveSubscription(Guid userId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<bool> CancelSubscription(int id, Guid userId, CancellationToken cancellationToken = default)
    {
        var subscription = await _db.Subscriptions
    ...
    public async Task<bool> TryUseSubscription(Guid userId, CancellationToken cancellationToken = default)
    {
        var subscription = await _db.Subscriptions
            .FirstOrDefaultAsync(x =>
                x.UserId == userId &&
