...
seed_cars AS (
    ...
    FROM (VALUES
        (
            ...
            'Chevrolet',
            'Cobalt',
            'Demo Partner'::varchar(255),
            '/internal/public/cars/Chevrolet Cobalt 2020/1/front.png'::varchar(2048),
            jsonb_build_array(
        ...
        (
            ...
            '/internal/public/cars/Chevrolet Cobalt 2020/2/side.png'::varchar(2048),
            jsonb_build_array(
                '/internal/public/cars/Chevrolet Cobalt 2020/2/side.png',
                '/internal/public/cars/Chevrolet Cobalt 2020/2/inside.png',
                '/internal/public/cars/Chevrolet Cobalt 2020/2/back.png'
            ),
            593.60::numeric(10, 2),
            10,
            5600000.00::numeric(12, 2),
        ...
        (
            ...
            '/internal/public/cars/Chevrolet Cobalt 2020/3/front.png'::varchar(2048),
            jsonb_build_array(
                '/internal/public/cars/Chevrolet Cobalt 2020/3/front.png',
                '/internal/public/cars/Chevrolet Cobalt 2020/3/back.png'
            ),
            593.60::numeric(10, 2),
            8,
            5600000.00::numeric(12, 2),
...
scheduled_bookings AS (
    SELECT
        ...
        24000 + (user_seed.sort_order * 10) + car_seed.sort_order AS car_comment_id,
        user_seed.user_id,
        ...
        TIMESTAMPTZ '2026-04-04 09:00:00+05'
...
completed_bookings AS (
    SELECT
        ...
        booking.start_time - INTERVAL '3 days' AS created_at,
        booking.start_time AS trip_started_at,
        booking.start_time + booking.billable_hours * INTERVAL '1 hour' AS trip_completed_at,
        booking.start_time + booking.billable_hours * INTERVAL '1 hour' + INTERVAL '8 hours' AS car_comment_submitted_at
