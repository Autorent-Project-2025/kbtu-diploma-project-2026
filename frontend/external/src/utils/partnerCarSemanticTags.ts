...
// econom and business are excluded from manual selection — computed automatically via suggestSemanticTags
...
export function suggestSemanticTags(
  ...
  if (typeof horsepower === "number" && horsepower <= 100) {
    push("econom");
  }
