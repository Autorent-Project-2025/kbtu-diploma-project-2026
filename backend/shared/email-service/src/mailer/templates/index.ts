export { approvedTemplate } from "./approvedTemplate.ts";
export { rejectedTemplate } from "./rejectedTemplate.ts";
export { partnerApprovedTemplate } from "./partnerApprovedTemplate.ts";
