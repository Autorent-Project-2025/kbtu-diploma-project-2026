    ...
    <div class="w-full max-w-5xl grid lg:grid-cols-[1.1fr,1fr] gap-8">
      ...
      >
        <div>
          ...
          <h1 class="text-4xl font-extrabold text-white mb-4">Внутренняя CRM AutoRent</h1>
          <p class="text-gray-400 text-lg leading-relaxed">
            Единое пространство для заявок, клиентов, партнёров и бронирований.
          </p>
        </div>
...
const features = [
  {
    title: "Один кабинет",
    desc: "Все основные операции собраны в одном месте.",
  },
  {
    title: "Связанные данные",
    desc: "Нужный контекст доступен без лишних переходов.",
  },
  {
